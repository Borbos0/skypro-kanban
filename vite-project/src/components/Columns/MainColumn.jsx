...
export default function Column({statusName, tag, description, date}) {
    return (
        <div class="main__column">
						<div class="column__title">
							<p>{statusName}</p>
						</div>
						<Card tag = {tag} description = {description} date = {date}/>
					</div>
    )
}
// export default function Column({array}) {
//     const column = array.map(arr => (
//         <div class="main__column">
// 						<div class="column__title">
// 							<p>{arr.statusName}</p>
// 						</div>
...
// 											<h3 class="card__title">{arr.description}</h3>
// 										</a>
