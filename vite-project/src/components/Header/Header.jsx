	...
	<div>
        ...
        <div class="container">
            <div class="header__block">
				...
				{/* #popNewCard */}
                    <button onClick={OnClick} class="header__btn-main-new _hover01" id="btnMainNew">Создать новую задачу</button>
                    <a href="#user-set-target" class="header__user _hover02" onClick={showProfile}>Ivan Ivanov</a>
					{isOpen && (
